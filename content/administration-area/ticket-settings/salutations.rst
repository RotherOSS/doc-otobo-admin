...
For example, the variable ``<OTOBO_CUSTOMER_DATA_UserLastname>`` expands to the customer's last name to be included in something like the following.

.. code-block:: text

   Dear <OTOBO_CUSTOMER_DATA_UserFirstname> <OTOBO_CUSTOMER_DATA_UserLastname>,
