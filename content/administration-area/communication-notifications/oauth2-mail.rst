...
Regardless whether OAuth2 is used for sending or fetching email,
...
.. note::
   ...
   as these will be specific to mail server and OIDC Provider used please refer to your email provider's instructions on how to setup authentication via OIDC.


.. note::
   The Functional Account configured in OTOBO will possibly need to have the proper OAuth2 scopes and/or resource ids configured specific to the mail server and OIDC Provider used.
   Again please refer to your email provider's documentation to determine the necessary settings.
